...
<div class="content">
    <div class="text-center">
        <h1>GASTOS NO OPERACIONALES UNITARIOS 2022</h1>
        <br>
        <div>
            <form action="gastosNofilterU" method="POST" class="form-row mb-4">
                @csrf
                <div class="col">
...
<!-- <script>
    ...
    btnExportar.addEventListener("click", function() {
        let tableExport = new TableExport(tabla, {
            exportButtons: false,
            filename: "Reporte GasNoOperUnitarios",
            sheetname: "Reporte GasNoOperUnitarios",
        });
