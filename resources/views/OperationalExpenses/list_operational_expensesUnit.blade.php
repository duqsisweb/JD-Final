...
<div class="content">
    <div class="text-center">
        <h1>GASTOS OPERACIONALES 2022 UNITARIOS</h1>
        <br>
        <form action="gastosUfilter" method="POST" class="form-row mb-4">
            @csrf
            <div class="col">
...
<script>
    ...
    btnExportar.addEventListener("click", function() {
        let tableExport = new TableExport(tabla, {
            exportButtons: false,
            filename: "Reporte GasOperacionalesUnit",
            sheetname: "Reporte GasOperacionalesUnit",
        });
