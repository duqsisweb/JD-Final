...
<div class="content">
    <div class="text-center">
        ...
        <br>
        <form action="costosfilter" method="POST" class="form-row mb-4">
            @csrf
            <div class="col">
    ...
    <table id="tabla" class="table" style="width: 100%; border: 1px solid #000; margin: 0 0 1em 1em">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @if($p<=$contador) @if($head=='TOTAL PRODUCTO TERMINADO' || $head=='TOTAL OTROS' || $head=='TOTAL COSTOS DE VENTAS' || $head=='UTILIDAD BRUTA' || $mes=='TRIMESTRE' ) @if(is_string($info[$p]))==false) <td>{{$info[$p]}}</td>
                        @else
