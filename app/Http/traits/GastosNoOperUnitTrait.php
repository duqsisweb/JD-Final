...
trait GastosNoOperUnitTrait
{
    ...
    public function tablaGastosNoOperacionalesUnit($fechaIni,$fechaFin)
    {
        if ($fechaIni != null) {
            $fechaIni = $fechaIni;
            $fechaFin = $fechaFin;
            ...
            if ($c == 3 || $c == 7 || $c == 11 || $c == 15) {
                ...
                switch ($c) {
                    case $c == 4:
                        ...
                        $utilAntesOp= $gastosOperacionalesUnitariosTabla[0][32]-$totalNoOper;
                    ...
                    case $c == 16 :
                        $gastosNoOperacionalesTabla= $this->tablaGastosNoOperacionalesC();
                        $gastosNoOperacionalesTabla= array_slice($gastosNoOperacionalesTabla,-1,1);
                        $cuenCos = count($gastosNoOperacionalesTabla[0]);
                        for ($a = 0; $a < $cuenCos; $a++) {
                            if ($a % 2 == 0) {
                            } else {
                        ...
                        $gastosNoOperacionalesTabla = array_values($gastosNoOperacionalesTabla[0]);
                        $ventasToneladasTabla= $this->TablaVentasToneladasC();
                        $ventasToneladasTabla= array_slice($ventasToneladasTabla,-1,1);
                        $ventasNetasUnitariasTabla= $this->TablaVentasUnitC();
                        $ventasNetasUnitariasTabla= array_slice($ventasNetasUnitariasTabla,-1,1);
                        $gastosOperacionalesUnitariosTabla= $this->tablaGastosOperacionalesUnitC();
                        $gastosOperacionalesUnitariosTabla= array_slice($gastosOperacionalesUnitariosTabla,-1,1);
                        $trimestre = [];
                        for ($b = 0; $b < count($gastosNoOperacionalesTabla)-3; $b++) {
                            $val= round($gastosNoOperacionalesTabla[$b]/$ventasToneladasTabla[0][0]);
                            array_push($trimestre, $val);
